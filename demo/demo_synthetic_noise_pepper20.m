% name:       demo_synthetic_noise_pepper20.m
% usage:      --
% author:     Ruicheng
% date:       2020-08-13 17:00:01
% version:    1.0
...
data_name = "synthetic_noise_pepper20";
addpath("../src")
...
param.nu        = 0.020*255*255; % coefficient of the length term
param.timestep  = .1;            % time step
